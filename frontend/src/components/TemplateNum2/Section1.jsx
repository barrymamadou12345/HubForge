...
<section>
  <div class="max-w-screen-xl mt-10 mx-auto px-4 py-6 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    <div className='text-center'>
      ...
      <p className='text-xl  '>apiente optio repellendus atque illum odio! Fugiat at expedita deserunt dolorum molestias.</p>
    </div>
   ...
   <div className='w-20 h-20 mx-auto'><img src={Etoile} className='w-full h-full' alt="" /></div>
