...
export default function Section4() {
  return (
    <div className="max-w-screen-xl mt-10 mx-auto px-4 py-6 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
      <div className='text-center'>
        <h2 className='text-5xl font-bold pb-5'>Trusted by thousands</h2>
        <p className='text-xl'>Repellendus atque illum odio! Fugiat at expedita deserunt dolorum molestias.</p>
      </div>
       ...
       <div class="relative overflow-hidden rounded-2xl bg-gradient-to-b from-gray-200 to-white p-px dark:from-gray-700 dark:via-gray-800 dark:to-darker">
                                <div class="relative flex h-full flex-col gap-6 rounded-2xl bg-gray-100 p-8 dark:bg-gray-900">
                                    <div class="flex gap-4">
                                        <img class="h-12 w-12 rounded-full" src={AV} alt="user avatar" width="400" height="400" loading="lazy"/>
                                        <div>
     ...
     <div class="relative overflow-hidden rounded-2xl bg-gradient-to-b from-gray-200 to-white p-px dark:from-gray-700 dark:via-gray-800 dark:to-darker">
      <div class="relative flex h-full flex-col gap-6 rounded-2xl bg-gray-100 p-8 dark:bg-gray-900">
        <div class="flex gap-4">
          <img class="h-12 w-12 rounded-full" src={AB} alt="user avatar" width="400" height="400" loading="lazy"/>
        <div>
            <h3 class="text-lg font-medium text-gray-700 dark:text-white">Daniella Doe</h3>
     ...
     <div class="space-y-6">
       ...
       <div class="relative overflow-hidden rounded-2xl bg-gradient-to-b from-gray-200 to-white p-px dark:from-gray-700 dark:via-gray-800 dark:to-darker">
           <div class="relative flex h-full flex-col gap-6 rounded-2xl bg-gray-100 p-8 dark:bg-gray-900">
               <div class="flex gap-4">
                   <img class="h-12 w-12 rounded-full" src={AC} alt="user avatar" width="400" height="400" loading="lazy"/>
                   <div>
       <h3 class="text-lg font-medium text-gray-700 dark:text-white">Daniella Doe</h3>
            <p class="text-sm text-gray-500 dark:text-gray-300">Mobile dev</p>
        </div>
    ...
    <p>Nostrum minus libero sit amet consectetur, adipisicing elit ab veniam sint non cumque quis tempore cupiditate. Sint libero voluptas veniam at reprehenderit, veritatis harum et rerum.</p>
      ...
      <div class="relative overflow-hidden rounded-2xl bg-gradient-to-b from-gray-200 to-white p-px dark:from-gray-700 dark:via-gray-800 dark:to-darker">
       <div class="relative flex h-full flex-col gap-6 rounded-2xl bg-gray-100 p-8 dark:bg-gray-900">
    <div class="flex gap-4">
        <img class="h-12 w-12 rounded-full" src={AD} alt="user avatar" width="400" height="400" loading="lazy"/>
        <div>
        <h3 class="text-lg font-medium text-gray-700 dark:text-white">Daniella Doe</h3>
          <p class="text-sm text-gray-500 dark:text-gray-300">@hundler</p>
        </div>
  ...
  <div class="relative overflow-hidden rounded-2xl bg-gradient-to-b from-gray-200 to-white p-px dark:from-gray-700 dark:via-gray-800 dark:to-darker">
      <div class="relative flex h-full flex-col gap-6 rounded-2xl bg-gray-100 p-8 dark:bg-gray-900">
           <div class="flex gap-4">
               <img class="h-12 w-12 rounded-full" src={AE} alt="user avatar" width="400" height="400" loading="lazy"/>
               <div>
                   <h3 class="text-lg font-medium text-gray-700 dark:text-white">Daniella Doe</h3>
                   <p class="text-sm text-gray-500 dark:text-gray-300">@hundler</p>
               </div>
